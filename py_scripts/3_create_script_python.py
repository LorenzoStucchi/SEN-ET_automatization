...
cmd_warp = python_path + "\\python " + python_path + "\\sen-et-snap-scripts\\warp_to_template.py --source PATHS3_obs_geometry.dim --template PATHS2_mask.dim --resample_algorithm " + algorithm + " --output PATHS3_hr_vza.dim"
