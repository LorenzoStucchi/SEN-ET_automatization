...
for date in date_s2:
    ...
    text = text + "echo \"Computed the leaf parameters for the image S2 " + str(date) + "\"\n"
    text = text + "echo \"\t Computing the fraction of green for the image S2 " + str(date) + "\"\n"
    text = text + cmd_fracgreen.replace("PATHS2", t_general_path_s2) + "\n"
    text = text + "echo \"Computed the fraction of green for the image S2 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the structural parameters for the image S2 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the aerodynamic parameters for the image S2 " + str(date) + "\"\n\n"
...
for date in date_s3:
    ...
    text = text + "echo \"Sharpened the image S3 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the meteo data for the day " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the longwave radiation for the image S3 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the shortwave radiation for the image S3 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the energy fluxes for the image S3 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Computed the evapotranspiration for the image S3 " + str(date) + "\"\n"
    
    # Write ET as geotiff
    text = text + "echo \"\t Saving the evapotranspiration maps into TIFF for the image S3 " + str(date) + "\"\n"
    ...
    text = text + "echo \"Saved the evapotranspiration maps into TIFF for the image S3 " + str(date) + "\"\n"
